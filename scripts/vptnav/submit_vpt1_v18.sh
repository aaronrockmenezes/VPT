#!/bin/bash
# Submit normal VPTnav VPT1 v18 generation.
# This is not A*. It runs keyboard_agent.py on task VPT-v18.
...
BASE_PATH="${BASE_PATH:-/users/arock3/scratch/VPT1_DATA/thesis/v18_vpt_1}"
NUM_GPUS="${NUM_GPUS:-8}"
TASK="${TASK:-VPT-v18}"
