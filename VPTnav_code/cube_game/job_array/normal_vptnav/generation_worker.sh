...
apptainer exec --nv --cleanenv \
  ...
  --env SETTLE_STEPS="${SETTLE_STEPS:-}" \
  --env STRATEGY_TARGET="${STRATEGY_TARGET:-}" \
  --env STRATEGY_MAX_ATTEMPTS="${STRATEGY_MAX_ATTEMPTS:-}" \
  --env STRATEGY_VERBOSE="${STRATEGY_VERBOSE:-}" \
  --env STRATEGY_IMAGES_PER_SCENE="${STRATEGY_IMAGES_PER_SCENE:-}" \
  --env STRATEGY_REQUIRED_YES="${STRATEGY_REQUIRED_YES:-}" \
  --env STRATEGY_REQUIRED_NO="${STRATEGY_REQUIRED_NO:-}" \
  --env STRATEGY_CAM_RED_THRESH="${STRATEGY_CAM_RED_THRESH:-}" \
  --env STRATEGY_CAM_NO_RED_MAX="${STRATEGY_CAM_NO_RED_MAX:-}" \
  --env STRATEGY_AGENT_GOAL_THRESH="${STRATEGY_AGENT_GOAL_THRESH:-}" \
  --env STRATEGY_AGENT_CAMERA_THRESH="${STRATEGY_AGENT_CAMERA_THRESH:-}" \
  --env STRATEGY_AGENT_DEADZONE_DEG="${STRATEGY_AGENT_DEADZONE_DEG:-}" \
  --env STRATEGY_AGENT_PERP_DEADZONE_DEG="${STRATEGY_AGENT_PERP_DEADZONE_DEG:-}" \
  --env STRATEGY_RAIL_EXTENT="${STRATEGY_RAIL_EXTENT:-}" \
  --env STRATEGY_CAMERA_GOAL_DISTANCE="${STRATEGY_CAMERA_GOAL_DISTANCE:-}" \
  --env STRATEGY_MAX_CAMERA_GOAL_DISTANCE="${STRATEGY_MAX_CAMERA_GOAL_DISTANCE:-}" \
  --env STRATEGY_MIN_CAMERA_GOAL_CLEARANCE="${STRATEGY_MIN_CAMERA_GOAL_CLEARANCE:-}" \
  --env STRATEGY_MIN_SELECTED_PAIR_DISTANCE="${STRATEGY_MIN_SELECTED_PAIR_DISTANCE:-}" \
  --env STRATEGY_MIN_AGENT_CLEARANCE="${STRATEGY_MIN_AGENT_CLEARANCE:-}" \
  --env STRATEGY_AGENT_OBSERVER_DISTANCE="${STRATEGY_AGENT_OBSERVER_DISTANCE:-}" \
  --env STRATEGY_AGENT_OBSERVER_JITTER="${STRATEGY_AGENT_OBSERVER_JITTER:-}" \
  --env STRATEGY_MIN_OCCLUDER_CLEARANCE="${STRATEGY_MIN_OCCLUDER_CLEARANCE:-}" \
  --env STRATEGY_OCCLUDER_INDEX="${STRATEGY_OCCLUDER_INDEX:-}" \
  --env STRATEGY_DISTRACTOR_CLEARANCE="${STRATEGY_DISTRACTOR_CLEARANCE:-}" \
  --env STRATEGY_OCCLUDER_SCALE_XY_MIN="${STRATEGY_OCCLUDER_SCALE_XY_MIN:-}" \
  --env STRATEGY_OCCLUDER_SCALE_XY_MAX="${STRATEGY_OCCLUDER_SCALE_XY_MAX:-}" \
  --env STRATEGY_OCCLUDER_SCALE_Z_MIN="${STRATEGY_OCCLUDER_SCALE_Z_MIN:-}" \
  --env STRATEGY_OCCLUDER_SCALE_Z_MAX="${STRATEGY_OCCLUDER_SCALE_Z_MAX:-}" \
  --env STRATEGY_DISTRACTOR_SCALE_MIN="${STRATEGY_DISTRACTOR_SCALE_MIN:-}" \
  --env STRATEGY_DISTRACTOR_SCALE_MAX="${STRATEGY_DISTRACTOR_SCALE_MAX:-}" \
  --env STRATEGY_CANDIDATE_POINTS="${STRATEGY_CANDIDATE_POINTS:-}" \
  --env STRATEGY_AXIS_CANDIDATES="${STRATEGY_AXIS_CANDIDATES:-}" \
  --env STRATEGY_MIN_VALID_CANDIDATES="${STRATEGY_MIN_VALID_CANDIDATES:-}" \
