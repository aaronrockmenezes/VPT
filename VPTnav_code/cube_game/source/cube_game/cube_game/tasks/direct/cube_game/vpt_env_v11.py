...
from .vpt_env_cfg_v11 import VPTEnvCfg
...
class VPTEnv(DirectRLEnv):
    ...
    def __init__(self,
        ...
        # File paths
        self.base_path = f"/home/arock3/data_v11_plus/data_{self.GPU_ID}"
    ...
    def _reset_idx(self, env_ids: Sequence[int] | None, randomize_objects: bool = True) -> None:
        ...
        for env_idx in range(self.num_envs):
            for obj_idx in range(self.cfg.num_vpt_objs):
                vpt_prim_paths.append(f"/World/envs/env_{env_idx}/obs_{obj_idx}")
        ...
        while self.next_env_id < self.total_envs_to_sim or len(self.completed_envs) < self.total_envs_to_sim:
            ...
            self.randomize_vpt_material(prim_paths=vpt_prim_paths)
