...
class VPTEnv(DirectRLEnv):
    ...
    def __init__(self,
        ...
        # File paths
        self.base_path = f"/home/arock3/data_v8_new/data_{self.GPU_ID}"
    ...
    def _get_active_vpt_dims(self, env_ids) -> torch.Tensor:
        ...
        if isinstance(env_ids, int):
            ...
            is_batch = False # Mark as originally scalar for potential squeeze if needed (optional)
        ...
        # 4. Lookup Dimensions using Advanced Indexing
        # self.all_vpt_dims shape: [total_objs, 3]
        batch_dims = self.all_vpt_dims[batch_indices] # Shape: [batch_size, active_objs, 3]

        # NOTE: We do NOT squeeze here. _reset_idx_internal expects [batch, obj, 3]
    ...
    def randomize_shape_color(self, prim_path_expr: str|list):
        ...
        with Sdf.ChangeBlock():
            for prim_path in prim_paths:
                ...
                rand_color = Gf.Vec3f(color[0], color[1], color[2])
