...
class VPTEnvCfg(DirectRLEnvCfg):
    ...
    reference_obj_cone = RigidObjectCfg(
        prim_path="/World/envs/env_.*/reference_obj_cone",
    ...
    reference_obj_cuboid = RigidObjectCfg(
        prim_path="/World/envs/env_.*/reference_obj_cuboid",
    ...
    reference_obj_cylinder = RigidObjectCfg(
        prim_path="/World/envs/env_.*/reference_obj_cylinder",
