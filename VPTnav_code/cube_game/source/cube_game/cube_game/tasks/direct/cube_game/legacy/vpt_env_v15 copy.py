...
class VPTEnv(DirectRLEnv):
    ...
    def __init__(self,
        ...
        # File paths
        self.base_path = f"/home/arock3/data_v15_new/data_{self.GPU_ID}"
    ...
    def _reset_idx(self,
        ...
        num_to_select = max(1, int(0.95 * len(env_ids)))
        ...
        while self.next_env_id < self.total_envs_to_sim or len(
            ...
            self.randomize_global_lights(prim_paths=["/World/Light", "/World/Light_A", "/World/Light_B"], random_light_off=True)
    ...
    def randomize_global_lights(self, prim_paths=["/World/Light_A", "/World/Light_B"], random_light_off=False):
        ...
        if random_light_off and len(prim_paths) > 0:
            # Keep at least 1 light on, turn off a random subset of the rest
