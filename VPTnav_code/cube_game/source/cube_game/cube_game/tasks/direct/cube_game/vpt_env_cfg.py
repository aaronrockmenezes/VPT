...
class VPTEnvCfg(DirectRLEnvCfg):
    ...
    sim: SimulationCfg = SimulationCfg(
        ...
        rendering_mode="balanced"  # Set this to 'quality' for data collection
        ))

    camera_obj = RigidObjectCfg(
        prim_path="/World/envs/env_.*/camera_obj",
        spawn=sim_utils.UsdFileCfg(
            usd_path="/mnt/VPT/VPTnav_code/cube_game/assets/new_cam_latest.usd",
    ...
    occlusion_camera: TiledCameraCfg = TiledCameraCfg(
        ...
        offset=TiledCameraCfg.OffsetCfg(
            ...
            rot=(1, 0, 0 ,0),
            convention="world"),
        data_types=["rgb", "semantic_segmentation"],  # Only depth
        spawn=sim_utils.PinholeCameraCfg(focal_length=24.0,
                                         focus_distance=40.0,
                                         horizontal_aperture=34.0,
                                         vertical_aperture=34.0,
    ...
    # obj_assignment = get_obj_assignment(shapes=["cuboid", "cylinder", "cone"], num_vpt_objs=num_vpt_objs)
    ...
    observation_space = Box(low=0,
                            high=255,
                            shape=(3, rgb_tiled_camera.height, rgb_tiled_camera.width))
