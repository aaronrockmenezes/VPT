...
class VPTEnv(DirectRLEnv):
    ...
    def __init__(self,
        ...
        self.verbose = 0
        self.goal_pixel_threshold = 200  # Minimum pixels for goal visibility
        ...
        self.rot_q_left = torch.tensor(
            [[math.cos(self.half_theta), 0., 0.,
              math.sin(self.half_theta)]],
            device=self.device)
    ...
    def move_agent(self, actions, env_ids: Sequence[int] | None = None):
        ...
        if moving_mask.any():
            ...
            displacement = world_vel_3d * 2.0 * dt
    ...
    def _randomize_scene_props(self, env_ids):
        ...
        # GLOBAL DISTANT LIGHTS HERE
        # self.randomize_global_lights(
        #     # prim_paths=["/World/Light", "/World/Light_A", "/World/Light_B", "/World/Light_C"],
        #     prim_paths=["/World/Light", "/World/Light_A"],
