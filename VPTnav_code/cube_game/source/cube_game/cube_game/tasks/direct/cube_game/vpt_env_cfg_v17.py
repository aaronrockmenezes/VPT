...
class VPTEnvCfg(DirectRLEnvCfg):
    ...
    camera_obj = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            # usd_path="VPTnav_code_v1/cube_game_alekh/source/cube_game/cube_game/tasks/direct/cube_game/new_cam_3_rot.usda",
            # Edit Aaron 19feb
            usd_path="/home/arock3/cube_game/assets/new_cam_latest.usd",
    ...
    #         pos=(0.0, 0.0, 0.0),
    #         #rot=(1.0, 0.0, 0.0, 0.0),  # No rotation relative to camera_obj
